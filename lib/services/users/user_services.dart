...
import 'package:controle_aluguel_mobile/models/usuarios/user.dart';
...
//obter instancia do firebase auth
  ...
  CollectionReference get _collectionCliente =>
      _firestore.collection('cliente');
...
// registrar o usuario no firebase
  ...
  Future<List<Cliente>> allClientes() async {
    QuerySnapshot querySnapshot = await _collectionCliente.get();
